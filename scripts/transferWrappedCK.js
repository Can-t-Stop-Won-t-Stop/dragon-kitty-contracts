...
async function start(){
	console.log("Transferring:", _WCKToken, "to", _addressTo, "from", _addressFrom);
	let response = await contract.methods.transferFrom(_addressFrom, _addressTo, _WCKToken).send({from:_addressFrom});
